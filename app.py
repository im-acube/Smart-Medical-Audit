...
if user_type == "🏠 Home":
    ...
    with tabs[0]:
        ...
        with col2:
            ...
            st.info("**How We Earn?**\n\nWe charge a commission only when we successfully negotiate and save you money. Plus, we have enterprise clients.")
        ...
        st.markdown("""
            <div class="negotiation-card">
                ...
                <p>4️⃣ You pay commission ONLY on actual savings</p>
                <hr>
